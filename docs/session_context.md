...
1. **Custom Upload UI Verification**:
   - After the GitHub-triggered Community Cloud redeployment completes, upload `kin-1.mp4` and confirm the synchronized dashboard is playable/downloadable in the browser.
